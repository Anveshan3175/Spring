...
public class ObjectFactory {
    ...
    private final static QName _Password_QNAME = new QName("http://com/blog/samples/webservices/personservice", "password");
    private final static QName _Login_QNAME = new QName("http://com/blog/samples/webservices/personservice", "login");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://com/blog/samples/webservices/personservice", name = "password")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://com/blog/samples/webservices/personservice", name = "login")
