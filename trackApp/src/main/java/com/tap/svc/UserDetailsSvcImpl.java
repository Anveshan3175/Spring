...
public class UserDetailsSvcImpl implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		User user = userDao.findUserByName(username); // our own User model
														// class
		...
		if (user != null) {
			 ...
			 * user.getStatus().equals(UserStatus.ACTIVE); boolean
			 * credentialsNonExpired =
			 * user.getStatus().equals(UserStatus.ACTIVE); boolean
			 * accountNonLocked = user.getStatus().equals(UserStatus.ACTIVE);
			 */
