...
<body>
	...
	<c:url value="/candidate/editSubmit" var="submitEditCandidate" />
	...
	<font color="red"> <form:errors path="candidate.*" /></font>
		<div class="panel-heading">
			<h3 class="panel-title">New Candidate Details</h3>
		</div>
		<div class="panel-body" style="background: #fafafa;">
			<form:form id="newCandidateForm" method="post" action="${submitEditCandidate}"
