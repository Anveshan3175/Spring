 ...
 * 
 */
@WebServiceClient(name = "PersonServices", targetNamespace = "http://com/anvesh/spring/wssecurity/pns", wsdlLocation = "file:/C:/Workspace/GenralWorkSpace/springWSSecurity/src/main/webapp/schemas/PersonWS.wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICES_QNAME = new QName("http://com/anvesh/spring/wssecurity/pns", "PersonServices");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/Workspace/GenralWorkSpace/springWSSecurity/src/main/webapp/schemas/PersonWS.wsdl");
    ...
    public PersonService getPersonServiceSoap11() {
        return super.getPort(new QName("http://com/anvesh/spring/wssecurity/pns", "PersonServiceSoap11"), PersonService.class);
    }
    ...
    public PersonService getPersonServiceSoap11(WebServiceFeature... features) {
        return super.getPort(new QName("http://com/anvesh/spring/wssecurity/pns", "PersonServiceSoap11"), PersonService.class, features);
    }
