 ...
 * 
 */
@WebServiceClient(name = "PersonServices", targetNamespace = "http://com/person/webservices/personSvc", wsdlLocation = "file:/C:/Workspace/GitHub/Spring/PersonWS/src/main/webapp/schemas/PersonWS.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/Workspace/GitHub/Spring/PersonWS/src/main/webapp/schemas/PersonWS.wsdl");
