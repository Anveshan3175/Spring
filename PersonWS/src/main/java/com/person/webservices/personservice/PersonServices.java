 ...
 * 
 */
@WebServiceClient(name = "PersonServices", targetNamespace = "http://com/person/webservices/personSvc", wsdlLocation = "file:/C:/Workspace/GenralWorkSpace/PersonWS/src/main/webapp/schemas/PersonWS.wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICES_QNAME = new QName("http://com/person/webservices/personSvc", "PersonServices");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/Workspace/GenralWorkSpace/PersonWS/src/main/webapp/schemas/PersonWS.wsdl");
    ...
    public PersonService getPersonServiceSoap11() {
        return super.getPort(new QName("http://com/person/webservices/personSvc", "PersonServiceSoap11"), PersonService.class);
    }
    ...
    public PersonService getPersonServiceSoap11(WebServiceFeature... features) {
        return super.getPort(new QName("http://com/person/webservices/personSvc", "PersonServiceSoap11"), PersonService.class, features);
    }
